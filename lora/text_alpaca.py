...
combined_dataset = concatenate_datasets([data_token_0, data_token_1])

print(tokenizer.decode(combined_dataset[0]["input_ids"]), "\n")

print(tokenizer.decode(combined_dataset[800]["input_ids"]), "\n")
